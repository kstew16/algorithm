...
fun main() = with(BufferedReader(InputStreamReader(System.`in`))){
    ...
    val rVisited = Array(n){BooleanArray(m){false} }.apply { this[red[0]][red[1]] = true }
    val bVisited = Array(n){BooleanArray(m){false} }.apply { this[blue[0]][blue[1]] = true }
    var ans = -1
    fun State.applyGravity(direction:Int):Boolean{
        ...
        if(!rVisited[nry][nrx]||!bVisited[nby][nbx]){
